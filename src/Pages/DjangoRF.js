...
class DjangoRF extends Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-9 " style={{ backgroundColor: Darktheme ? '#242526' : '#fffefe' }}>
              ...
              <div className="">
                <div className="">
                  ...
                  >
                    Extends User in <code>Django-Rest-Framwork</code> Login Token Auth
                  </p>
                  <p className="mx-4" style={{ color: Darktheme ? 'grey' : 'grey' }}>
                    <FaClock className="mr-2" />  Jan 7, 2023 <FaEye className="mx-2" /> {this.state.views} views
                  </p>
 ...
 'rest_framework.authtoken',
  ...
  `}
                  ...
                  <p
                    ...
                    Open your app <code>url.py</code> and add this line.
  ...
  `}
                  ...
                  <p
                    ...
                    then add this in your <code>urlpatterns</code> list
                  </p>
  ...
  `}
                  ...
                  <p
                    ...
                    This is all first Technique, just visit your localhost:8080/login, then you can test your default user-django (admin)
                  </p>
 ...
 from rest_framework.authtoken.models import Token
  ...
  `}
                  ...
                  <p
                    ...
                    If you hava'n allready created Django App, create now and in the <code>view</code> module add this class
                  </p>
...
class Signin(ObtainAuthToken):
    def post(self, request, *args, **kwargs):
        reponse = super(Signin, self).post(request, *args, **kwargs)
        token = Token.objects.get(key=reponse.data['token'])
        user=  User.objects.get(id=token.user_id)
        serializedUser = UserSerializer(user)
        return Response({"token":token.key, "user":serializedUser.data})
  ...
  `}
                  ...
                  <p
                    ...
                    If you see the code the view is accessing <code>UserSerializer</code> create your own serializer or use this bellow <code>user-serializer</code> module.
...
class UserSerializer(serializers.ModelSerializer):
  ...
  `}
                  ...
                  <p
                    ...
                    Then add this line to your project <code>url</code> module
                  </p>
  ...
  ~~~py
  from RestApi import views // RestApi is may new app

  // then add this in your urlpatterns
  ...
  `}
                  ...
                  <p
                    ...
                    That is The Second Technique, if you visit localhost:8080/login and you pass the credential system will return the token as well as login user information, you can use Thunder Client or others for testing your APIs
                  </p>
