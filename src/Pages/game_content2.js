...
class Game_Content2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-9 " style={{ backgroundColor: Darktheme ? '#242526' : '#fffefe' }}>
              ...
              <div className="">
                <div className="">
                  ...
                  >
                    Godot 3D Camera Camera Controller Movement
                  </p>



                  <p className="mx-4" style={{ color: Darktheme ? 'grey' : 'grey' }}>
                    <FaClock className="mr-2" />  Dec 20, 2022 <FaEye className="mx-2" /> {this.state.views} views
                  </p>
...
func _ready() -> void:
  ...
  `}
                  ...
                  <p
                    ...
                    <code>onready var Zalson : = get_parent()</code> Assuming your parent Node is called Zalson
                  </p>
