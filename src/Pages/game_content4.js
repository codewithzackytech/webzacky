...
class Game_Content4 extends Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-9 " style={{ backgroundColor: Darktheme ? '#242526' : '#fffefe' }}>
              ...
              <div className="">
                <div className="">
                  ...
                  >
                    3D Game Level transition using Godot Engine
                  </p>
                  <p className="mx-4" style={{ color: Darktheme ? 'grey' : 'grey' }}>
                    <FaClock className="mr-2" />  Dec 17, 2022 <FaEye className="mx-2" /> {this.state.views} views
                  </p>
                  ...
                  <p
                    ...
                    For example you have a Button called new Game in the first window of your game when user click it that redirect to last Played Level, if you want this kind of functionality use this code, by the way <code>_on_newGame_button_up()</code> is not regular function is a <code>signal</code> function. if you don't know how to make signal function in godot just google it.
 ...
 func _on_newGame_button_up() -> void:
  ...
  `}
                  ...
                  <p
                    ...
                    But if you don't want to change the Level by clicking a Button, But you want to change the level Automatically when level ends, Just Use the same but change the button signal to your area signal like this.
                  </p>
