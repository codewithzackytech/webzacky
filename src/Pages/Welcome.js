...
import developer from "../assets/images/dev.jpg";
...
import pack from "../assets/images/2.jpg";
import pack2 from "../assets/images/1.jpg";

import icon4 from "../assets/images/icon4.png";
import { FaReact, FaPython, FaNodeJs, FaAndroid, FaFlask, FaCoffee, FaLinkedin, FaWhatsapp, FaFacebook, FaGithub, FaMoon, FaSun, FaBars, FaTimes as FaClose, FaComment, FaEye, FaClock, FaLeaf, FaGamepad, FaCode, FaWaze, FaUser, FaRegShareSquare, FaLinkedinIn, FaInstagram } from 'react-icons/fa';
    ...
    return (
      ...
      >
        ...
        <div className="mt-0">
          ...
          <WelContent Darktheme={Darktheme}
          ...
          <div class="content-wrapper" style={{
            ...
            <div class="container" id="tutorial">
              ...
              <section class="customer-feedback" id="opensource">
                <div class="row justify-content-center align-itemc-center">
                  <div class="col-12  text-center pb-5 col-md-8">
                    <h2 className="text-success mx-3">Projects</h2>
                    <h6 class="section-subtitle text-muted m-0 mx-5">
                      Free OpenSource Projects
                    </h6>
                  </div>
                  <div class="owl-carousel owl-theme grid-margin customersBox">


                    <div
                      class="card customer-cards m-3 col-md-3"
                      style={{
                        backgroundColor: this.state.isDark ? "#363738" : null,
                      }}
                    >
                      <a href="https://github.com/codewithzackytech/reactjs-repo">
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <h6 class="card-title pt-3 text-success fw-bolder">
                              React.js
                            </h6>
                            <h6 class={`customer-designation m-0 ${Darktheme ? 'text-white' : 'text-muted'}`}>
                              Open Source Project
                            </h6>
                          </div>
                        </div>
                    ...
                    >
                      <a href="https://github.com/codewithzackytech/reactnative-repo">
                        <div class="card-body">
                          <div class="text-center">
                            <FaAndroid size={60} color="green" />


                            <div class="content-divider m-auto"></div>
                            <h6 class="card-title pt-3 fw-bolder" style={{ color: 'green' }}>
                              ReactNative / Android
                            </h6>
                            <h6 class={`customer-designation m-0 ${Darktheme ? 'text-white' : 'text-muted'}`}>
                              Open Source Project
                    ...
                    >
                      <a href="https://github.com/codewithzackytech/electronjs-repo">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <div class="content-divider m-auto"></div>
                            <h6 class="card-title pt-3 fw-bolder" style={{ color: Darktheme ? 'skyblue' : 'black' }}>
                              Electron.js
                            </h6>
                            <h6 class={`customer-designation m-0 ${Darktheme ? 'text-white' : 'text-muted'}`}>
                              Open Source Project
                    ...
                    >
                      <a href="https://github.com/codewithzackytech/nodejs-repo">
                    ...
                    >
                      <a href="https://github.com/codewithzackytech/godot-repo">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <div class="content-divider m-auto"></div>
                            <h6 class="card-title pt-3 fw-bolder" style={{ color: 'dodgerblue' }}>
                              Games
                            </h6>
                            <h6 class={`customer-designation m-0 ${Darktheme ? 'text-white' : 'text-muted'}`}>
                              Open Source Project
                    ...
                    >
                      <a href="https://github.com/codewithzackytech/Django-repo">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <div class="content-divider m-auto"></div>
                            <h6 class="card-title pt-3 fw-bolder" style={{ color: 'gold' }}>
                              Python / Django
                            </h6>
                            <h6 class={`customer-designation m-0 ${Darktheme ? 'text-white' : 'text-muted'}`}>
                              Open Source Project
              ...
              <section class="customer-feedback pt-5 px-2" id="opensource" style={{ backgroundColor: `${Darktheme ? "#333" : "#f0f0f0"}` }}>
                <div class="row justify-content-center align-itemc-center">
                  <div class="col-12  text-center pb-5 col-md-8">
                    <h2 className="text-success mx-3">Who Making WebZacky?</h2>
                    <h6 class={`section-subtitle ${Darktheme ? 'text-muted' : 'text-muted'} m-0 mx-5 mt-4 px-0`}>
                      It is developed by a freelance developer, Zacky Jamel, based in Somali.
                    </h6>


                  </div>
                  <div class="owl-carousel owl-theme grid-margin customersBox mb-0 pb-0">
                    <img src={developer}
                      // width={'30%'}
                      style={{ borderRadius: 300 }}
                      // height={100}
                      className="mx-4 my-3 col-md-3 p-5"
                    />



                  </div>
                  <div className="col justify-content-center align-items-center d-flex pb-5">
                    <a href="https://et.linkedin.com/in/zacky-jamel-17a31b239?trk=people_directory"><FaLinkedinIn className="text-info mx-3" size={30} /></a>

                    <a href="https://github.com/codewithzackytech"><FaGithub className="text-muted mx-3" size={30} /></a>
                  </div>
