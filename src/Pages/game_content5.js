...
import dd1 from "../assets/images/godot/2d1.png";
...
class Game_Content5 extends Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-9 " style={{ backgroundColor: Darktheme ? '#242526' : '#fffefe' }}>
              ...
              <div className="">
                <div className="">
                  ...
                  >
                    Build Your First 2D Game using Godot Engine
                  </p>
                  <p className="mx-4" style={{ color: Darktheme ? 'grey' : 'grey' }}>
                    <FaClock className="mr-2" />  Dec 5, 2022 <FaEye className="mx-2" /> {this.state.views} views
                  </p>
                  ...
                  <p
                    ...
                    <a href="https://github.com/codewithzackytech/Simple2DGame"><span className="text-info">here</span></a> is the complete project
