...
class ElectronDeployment extends Component {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-9 " style={{ backgroundColor: Darktheme ? '#242526' : '#fffefe' }}>
              ...
              <div className="">
                <div className="">
                  ...
                  >
                    Electron.js Multi-Platform Architecture Deployment
                  </p>
                  ...
                  <p
                    ...
                    In this tutorial i'm gonna show you how to deploy <code>electron.js</code> application using two deployment tools <code>electron-packager</code> and <code>electron builder</code> so if you complete your app and the only thing you need for now is just deployment, this tutorial is for you.
                  </p>
                  ...
                  <p
                    ...
                    Electron Packager is one of the electron deployment tools, but using this tools there is only binary file like <code>.exe</code> but there no installer, the purpose is may be you wanna use other installer makers like <code>Inno Setup</code>, so that is why many developers like this package bcz they wanna there own custom installer maker not default one. so if you wanna executable file only this tool is for you.
                  </p>
  ...
  ~~~py
 npm install electron-packager or yarn add electron-packager
  ~~~
  ...
  `}
                  ...
                  <p
                    ...
                    Add this to your <code>package.json</code> in the <code>scripts</code> like this.
                  </p>
 ...
 "package-linux": "electron-packager . electron-serialport --overwrite --asar=true --platform=linux --arch=x64 --prune=true --out=release-builds" 
  ...
  `}
                  ...
                  <p
                    ...
                    This tool is like <code>electron packager</code> but the d|f is this tools builds the <code>installer</code> and the <code>executable</code> file, so there is two options you can go.
                  </p>
...
export default ElectronDeployment;
