...
class Bcrypt extends Component {
            ...
            <main class="col-md-9 ml-sm-auto col-lg-9 " style={{ backgroundColor: Darktheme ? '#242526' : '#fffefe' }}>
              ...
              <div className="">
                <div className="">
                  ...
                  >
                    Hashing Passwords in <code>Node.js</code> and <code>Express.js</code> using bcrypt
                  </p>
                  ...
                  >
                    Im asuming every is setup Routing, APis, or may be Database, but the only thing you need is how Hashing is implemented.
                  </p>
 ...
 // number 10 means hash will re-hash 10 times
 // this is why bcrypt is powerfull then MD5 and Hash1...
 ...
 console.log({
  ...
  `}
                  ...
                  <p
                    ...
                    Checking The Hash. in MD5 or others Algorithms we first decrypt the hash then we check if it's correct or not
                  </p>
                  ...
                  <p
                    ...
                    But in-case of bcrypt without decrypting we can only compare the hash and password using <code>compare</code> function
                  </p>
