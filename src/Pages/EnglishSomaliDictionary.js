...
class EnglishSomaliDictionary extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    DashboardDashboardDashboardDashboardDashboardDashboard
                            ...
                            <div className="">
                                <div className="">
                                    ...
                                    <video src={DemoVideo} className="col-md-8 mx-3"
                                        autoPlay={true}
                                        loop={true}
                                    ...
                                    <Comments
                                        ...
                                        tutorialName={'English Somali Dictionary for PC'}
                                    />
...
export default EnglishSomaliDictionary;
